export const products: Product[] = [
  {
    ...
    longDescription: "Genuine Windows 11 Pro license key. Instant delivery via email. Supports all regions.",
  ...
  },
  {
    ...
    longDescription: "Full Microsoft 365 package including Word, Excel, PowerPoint. Works on all devices.",
  ...
  },
  {
    ...
    longDescription: "Access Photoshop, Premiere Pro, After Effects and more. Delivered instantly.",
  ...
  },
  {
    ...
    longDescription: "AutoCAD license for engineers and designers. Fast delivery and activation support.",
